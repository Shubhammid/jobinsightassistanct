    ...
    <div className="sticky bottom-0 w-full bg-white">
      <div className="flex flex-row gap-3 mx-2 md:mx-4 md:last:mb-6 py-3 lg:mx-auto lg:max-w-2xl xl:max-w-3xl">
        <div className="relative flex flex-col h-full flex-1 px-4 mb-0 lg:-mb-3 w-full">
          ...
          />
          <div className="relative flex flex-col w-full border-gray-300 border-[0.5px] shadow-md rounded-2xl p-3 !bg-[rgba(243,244,246,.3)]">
            <AutosizeTextarea
              ref={textAreaRef}
              rows={3}
              minHeight={20}
              ...
              className="resize-none pr-12 !text-[15px] border-0 !bg-transparent !shadow-none !ring-0 focus-visible:!ring-offset-0 focus-visible:!ring-0"
            />
            <div className="flex w-full items-center justify-between pt-3">
              <div className="flex items-center gap-2">
                <Button
                  variant="outline"
                  size="sm"
                  className="rounded-full font-normal !text-[13px] !bg-primary/5 !text-primary !border-primary"
                >
                  <Lightbulb />
                  Job Insights
                </Button>
              ...
              <Button
                ...
                size="icon"
                className="right-[8px] !bg-black disabled:pointer-events-none !text-white disabled:!bg-gray-500"
                onClick={() => {
                  handleSubmit(input);
                  textAreaRef.current?.textArea.focus();
                }}
